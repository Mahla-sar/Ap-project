...
Q_CONSTINIT static const qt_meta_stringdata_CLASSsigninENDCLASS_t qt_meta_stringdata_CLASSsigninENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 8),  // "sendinfo"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 23),  // "on_buttonBox_2_accepted"
        QT_MOC_LITERAL(41, 23)   // "on_buttonBox_2_rejected"
    },
    "signin",
    "sendinfo",
    "",
...
void signin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (signin::*)(QString );
            if (_t _q_method = &signin::sendinfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void signin::sendinfo(QString _t1)
{
